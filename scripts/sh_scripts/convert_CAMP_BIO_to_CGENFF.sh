...
# how to get the map
# cat charmm36.prm | awk '{if ($1 == "biotype") {print}}' | sed -e 's|".*"||' | awk '{if (($4 >= 57) && ($4 <=59)) {print $4+57} else if (($2 == 344) || ($2 == 364) || ($2 == 6) || ($2 == 1200)) {print "117"} else {print $6}}' > tmplst
...
# bonded_type  110      ! CT2A Special bonded type CT2A (polypeptide side chains GLU, ASP, HSP)
